...
echo
echo Continue to create GitHub TAP GitOps Repo tap-gitops-a4b
echo     https://github.com/tfynes-pivotal/tap-gitops-a4b
echo
...
git add .
git commit -am "."
gh repo create tap-gitops-a4b --private
git remote add origin https://github.com/tfynes-pivotal/tap-gitops-a4b
git branch -M main
